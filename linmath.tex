...
\section{行列の標準形}
  \subsection{標準形のまとめ}
    \plainpar{}{
      ここまでには掲載していないものも含め，本文書で挙げる標準形の一覧を以下に掲げる：
      \begin{center}
        \begin{tabular}{cccc}
        \hlinevar{2pt}
...
\section{線型計画法}
  ...
  \subsection{双対性}
    ...
    \TODO{
      $\theta = 0$ のとき示せない．というか反例があるっぽい？：
      \begin{align*}
        \vecu = (1, 0), \vecv = \begin{genmat}{c}1\\0\end{genmat}, A = \begin{genmat}{cc}0&2\\-2&0\end{genmat},
        \vecb = \begin{genmat}{c}0\\0\end{genmat}, \vecc = (1, 0)
      \end{align*}
    }
    \thmpar{相補最適性}{
