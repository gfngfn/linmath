  ...
  \subsection{双対性}
    ...
    \thmpar[thm:expansion-of-farkas-lemma]{}{
      ...
      \begin{multline*}
        \forallin{A}{\setMatrix{m}{n}{K}}{\forallin[2]{\vecb}{\setMatrix{m}{1}{K} \setmns \setprn{\veczero}}{
          \lflimpleqv{
            \existsin{\vecx}{\setMatrix{n}{1}{K}}{\lfland{A \vecx \leq \vecb}{\vecx \geq \veczero}}
          }{
            \forallin{\vecy}{\setMatrix{1}{m}{K}}{\lflimpl{\lfland{\vecy A \geq \veczero}{\vecy \geq \veczero}}{\vecy \vecb \geq 0}}
          }
        }}
      \end{multline*}
    }
    \proof{}{
      \begin{align*}
        &\existsin{\vecx}{\setMatrix{n}{1}{K}}{\lfland{A \vecx \leq \vecb}{\vecx \geq \veczero}}
      \\&\iff
          \existsin{\vecx}{\setMatrix{n}{1}{K}}{\existsin{\vecs}{\setMatrix{m}{1}{K}}{
    ...
    \proof{}{
      弱双対定理より，或る実行可能解 $\vecx$，$\vecy$ が存在して $\vecc \vecx \geq \vecy \vecb$ を満たすこと，すなわち
      \begin{align*}
        \existsin{\vecx}{\setMatrix{n}{1}{K}}{\existsin{\vecy}{\setMatrix{1}{m}{K}}{
          \lfland{
